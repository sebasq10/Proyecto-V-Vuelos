		...
		<div class="container col-xl-10 col-xxl-8 px-4 py-5">
            <div class="row align-items-center g-lg-5 py-5">
                ...
                <div class="col-md-10 mx-auto col-lg-6">
                    ...
                    <div class="form-floating mb-3">
                        <asp:Textbox type="text" name="Contraseña" runat="server" id="txtOldPass" class="form-control" placeholder="Vieja Contraseña"/>
                        <label for="floatingPassword">Contraseña</label>
                    </div>
                    <hr class="my-4">
                    <div class="form-floating mb-3">
                        <asp:Textbox type="text" name="NewPass" runat="server" id="txtNewPass" class="form-control" placeholder="Nueva Contraseña"/>
