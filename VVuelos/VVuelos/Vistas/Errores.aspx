<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Errores.aspx.cs" Inherits="VVuelos.Vistas.Errores" %>
          ...
          <ul class="list-unstyled ps-0">
            <li class="mb-1">
              <button class="btn btn-toggle align-items-center rounded collapsed text-white" data-bs-toggle="collapse"
                data-bs-target="#seguridad-collapse" aria-expanded="true"> Seguridad </button>
                ...
                <div class="col-10">
                  <nav aria-label="breadcrumb ms-4">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><a href="Errores.aspx">Errores</a></li>
                    </ol>
                  </nav>
                </div>
                <div class="col-2">
