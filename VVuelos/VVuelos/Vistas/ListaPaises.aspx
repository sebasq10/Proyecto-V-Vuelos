<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaPaises.aspx.cs" Inherits="VVuelos.Vistas.ListaPaises" %>
        ...
        <div class="flex-shrink-0 p-4 bg-color-primario texto-sidebar-primario" style="width: 280px;">
          ...
          <ul class="list-unstyled ps-0">
            ...
            <li class="mb-1">
              ...
              <div class=" show" id="administracion-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <div class="col-10">
                  <nav aria-label="breadcrumb ms-4">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><a href="ListaPaises.aspx">Países</a></li>
                    </ol>
                  </nav>
                </div>
                <div class="col-2">
              ...
              <div class="row">
                ...
                <div class="col-8">
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="numeroConsecutivo" placeholder="" value="P-1" readonly>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <label for="numeroConsecutivo" class="col-sm-2 col-form-label">Nombre:</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="numeroConsecutivo" placeholder="" value="Costa Rica">
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-2">
                      ...
                      <img src="https://www.banderas-mundo.es/data/flags/w580/cr.png" alt="Costa Rica" width="100" height="60">
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <div class="col-sm-4">
