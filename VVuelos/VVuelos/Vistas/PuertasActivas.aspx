<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PuertasActivas.aspx.cs" Inherits="VVuelos.Vistas.PuertasActivas" %>
                ...
                <div class="col-10">
                  <nav aria-label="breadcrumb ms-4">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><a href="PActivas.html">Puertas</a></li>
                    </ol>
                  </nav>
                </div>
                <div class="col-2">
